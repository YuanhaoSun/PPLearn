...
# data_set = joblib.load('../../Dataset/train_datasets/data_set_sem_internal_sentence_wsd.pkl')
# data_set = joblib.load('../../Dataset/train_datasets/data_set_sem_internal_sentence_wsd_wu.pkl')
# data_set = joblib.load('../../Dataset/train_datasets/data_set_sem_internal_sentence_wsd_jiang.pkl')

# data_set = joblib.load('../../Dataset/train_datasets/data_set_negation_bigram.pkl')
# data_set = joblib.load('../../Dataset/train_datasets/data_set_pos_negation_bigram.pkl')


# data_set = joblib.load('../../Dataset/train_datasets_3/data_set_origin.pkl')
# data_set = joblib.load('../../Dataset/train_datasets_3/data_set_stemmed.pkl')
# data_set = joblib.load('../../Dataset/train_datasets_3/data_set_lemmatized.pkl')
# data_set = joblib.load('../../Dataset/train_datasets_3/data_set_lemmatized_pos.pkl')
# data_set = joblib.load('../../Dataset/train_datasets_3/data_set_negation_bigram.pkl')
...
# data_set = joblib.load('../../Dataset/train_datasets_3/data_set_pos_tagged.pkl')
# data_set = joblib.load('../../Dataset/train_datasets_3/data_set_pos_bagged.pkl')

# data_set = joblib.load('../../Dataset/train_datasets_3/data_set_sem_firstsense.pkl')
# data_set = joblib.load('../../Dataset/train_datasets_3/data_set_sem_internal_word_wsd.pkl')
# data_set = joblib.load('../../Dataset/train_datasets_3/data_set_sem_internal_sentence_wsd.pkl')
# data_set = joblib.load('../../Dataset/train_datasets_3/data_set_sem_internal_sentence_wsd_wu.pkl')
# data_set = joblib.load('../../Dataset/train_datasets_3/data_set_sem_internal_sentence_wsd_jiang.pkl')
# data_set = joblib.load('../../Dataset/train_datasets_3/data_set_sem_corpus_word_wsd.pkl')
# data_set = joblib.load('../../Dataset/train_datasets_3/data_set_sem_corpus_sentence_wsd.pkl')
# data_set = joblib.load('../../Dataset/train_datasets_3/data_set_sem_corpus_sentence_wsd_jiang.pkl')

# data_set = joblib.load('../../Dataset/train_datasets_3/data_set_negation_bigram.pkl')
data_set = joblib.load('../../Dataset/train_datasets_3/data_set_pos_negation_bigram.pkl')
...
# ch2 = SelectKBest(chi2, k = 274) # for pos_bi_neg (3-class)
# ch2 = SelectKBest(chi2, k = 275) # for bi_neg and pos_bi_neg (8-class)
# ch2 = SelectKBest(chi2, k = 268) # for pos tagged 3-class
ch2 = SelectKBest(chi2, k = 277)
...
print "Overall f1-score:   %0.2f" % ( 100 * ( (2*pre_total_array.mean()*rec_total_array.mean()) / (rec_total_array.mean()+pre_total_array.mean()) ) )
print "Overall f0.5-score: %0.2f" % ( 100 * ( (1.25*pre_total_array.mean()*rec_total_array.mean()) / (rec_total_array.mean()+0.25*pre_total_array.mean()) ) )
