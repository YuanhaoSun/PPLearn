...
# similarity_overlap.sim_overlap
# similarity_overlap_idf.sim_overlap_idf
# similarity_overlap_phrasal.sim_overlap_phrasal
# similarity_sem_firstsense_alpha.sim_sem_firstsense_alpha
# similarity_sem_firstsense_pos.sim_sem_firstsense_pos
# similarity_sem_intermax.sim_sem_intermax
# similarity_syntactic_wordorder.sim_wordorder


# Construct training from train data
t0 = time()
X_train = get_prob(data_train, data_train, similarity_overlap_idf.sim_overlap_idf)
y_train = data_train.target
print "done in %fs" % (time() - t0)

# Learn
# No ML, 58 67 / 87 89
clf = LinearSVC(loss='l2', penalty='l1', C=1000, dual=False, tol=1e-3) #73 76 / 91
...
# Predict
t0 = time()
X_test = get_prob(data_train, data_test, similarity_overlap_idf.sim_overlap_idf)
