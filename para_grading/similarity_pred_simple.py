...
# pred = predict(data_train, data_test, similarity_sem_intermax.sim_sem_intermax)
# pred = predict(data_train, data_test, similarity_syntactic_wordorder.sim_wordorder)
