...
data_test = load_files('../Privacypolicy/test_10', categories = categories,
                        shuffle = True, random_state = 42)
print 'data loaded'
...
# Normalization does not make differences
# X_train = Normalizer(norm="l2", copy=False).transform(X_train)
