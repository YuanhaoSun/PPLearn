...
categories = ['Subscription','CA' ]
# categories = ['Collect Automatic','Collect Other', 'Collect User' ]
# categories = ['Cookies','Cookies Choice' ]
# categories = ['Share Third Party','Share Statement','Share MA','Share Law']

t0 = time()

# Load data
data_set = load_files('../Privacypolicy/l2_ca', categories = categories,
# data_set = load_files('../Privacypolicy/l2_collect', categories = categories,
# data_set = load_files('../Privacypolicy/l2_cookies', categories = categories,
# data_set = load_files('../Privacypolicy/l2_share', categories = categories,
...
for i in range(num_run):
    ...
    X, y = shuffle(X_orig, y_orig, random_state=(i+20))
...
print "F1 - %0.2f" % (100*(2*pre_total_array.mean()*rec_total_array.mean())/(rec_total_array.mean()+pre_total_array.mean()))
print "F5 - %0.2f" % (100*(1.25*pre_total_array.mean()*rec_total_array.mean())/(rec_total_array.mean()+0.25*pre_total_array.mean()))
